...
def face_morphing(img1,landmarks1,img2,landmarks2):
    ...
    for j in range(len(alpha)):
        ...
        with open("morphing_img/triangulation.txt") as file :
            for line in file :
                x,y,z = line.split(',')
                ...
                morphTriangle(img1, img2, imgMorph, t1, t2, t, alpha1)


        # Display Result
        # cv2.imshow("Morphed Face", np.uint8(imgMorph))
        # print(np.uint8(imgMorph))
        # cv2.waitKey(1)
        morph[j] = np.uint8(imgMorph)
        print(1)
    return  morph

#example of using face_morphing

# outputs = face_morphing('morphing_img/15.jpg','morphing_img/16.jpg')
